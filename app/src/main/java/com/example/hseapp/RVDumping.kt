...
class RVDumping : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rvdumping)
        getpref()
        sendSQLiteDataToApi()
        swipeRefreshLayout = findViewById(R.id.swipedumping)
        ...
        val actionbutton = findViewById<FloatingActionButton>(R.id.fabdumping)
    ...
    private fun getpref(){
        ...
        recyclerView = findViewById(R.id.rv_datadumping)
    ...
    private fun sendSQLiteDataToApi() {
        ...
        if (dataList.isNotEmpty()) {
            ...
            for (data in dataList) {
                ...
                val call = apiClient.Dumpingupload(dataList,imageBody,imageBody2)
                call.enqueue(object : retrofit2.Callback<Void> {
                    override fun onResponse(call: retrofit2.Call<Void>, response: retrofit2.Response<Void>) {
                        if (response.isSuccessful) {
                            ...
                            Toast.makeText(this@RVDumping, "Gagal mengirim data ke API. Pesan kesalahan: $errorMessage", Toast.LENGTH_SHORT).show()
                        }
                    }

                    override fun onFailure(call: retrofit2.Call<Void>, t: Throwable) {
                        Toast.makeText(this@RVDumping, "Terjadi kesalahan dalam permintaan: ${t.message}", Toast.LENGTH_SHORT).show()
                    }
                })
            }
        } else {
