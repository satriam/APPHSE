...
class AdapterDumping(private val dataList: List<DumpingEntity>): RecyclerView.Adapter<AdapterDumping.ViewHolderData>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderData, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            intent.putExtra("id_dumping", data.id_dumping)
