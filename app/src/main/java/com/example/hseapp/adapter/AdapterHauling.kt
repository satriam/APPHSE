...
class AdapterHauling(private val dataList: List<HaulingEntity>): RecyclerView.Adapter<AdapterHauling.ViewHolderData>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderData, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            intent.putExtra("id_hauling", data.id_hauling)
